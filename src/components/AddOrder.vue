<template>
  <div>
    <b-form @submit.prevent="saveOrder" v-if="!submitted">
      ...
      <b-form-group id="input-group-1" label-for="input-1" label="Nombre">
        <b-form-input id="input-1" required v-model="order.nombre" />
      </b-form-group>
      <b-form-group id="input-group-2" label-for="input-2" label="Tarifa">
        <b-form-input
          id="input-2"
          required
      ...
      <b-form-group id="input-group-3" label-for="input-3" label="Columnas">
        <b-form-input
          id="input-3"
          required
          v-model="order.col"
      ...
      <b-form-group id="input-group-4" label-for="input-4" label="Alto">
        <b-form-input
          id="input-4"
          required
          v-model="order.alto"
      ...
      <b-form-group
        >Total: <strong>$ {{ total }}</strong></b-form-group
      >
      ...
      >
        <b-form-select
          ...
          v-model="order.medio"
          :options="[
            { text: 'Rosario 12', value: 'Rosario 12' },
            { text: 'Pagina 12', value: 'Pagina 12' },
          ]"
          :value="'Rosario 12'"
        ></b-form-select>
      </b-form-group>
      <b-form-group id="input-group-6" label-for="input-6" label="Nota">
        <b-form-textarea rows="3" id="input-6" v-model="order.notas" />
      </b-form-group>
      <hr />
      <b-card bg-variant="light" title="Cliente">
        ...
        >
          <b-form-input
            ...
            disabled
            required
            v-model="this.order.cliente.nombre"
          ></b-form-input>
        </b-form-group>
        <b-form-group
          label="CUIT:"
        ...
        >
          <b-form-input
            ...
            disabled
            v-model="this.order.cliente.cuit"
          ></b-form-input>
        </b-form-group>
        <b-form-group
          label="Telefono:"
        ...
        >
          <b-form-input
            ...
            disabled
            v-model="this.order.cliente.tel"
          ></b-form-input>
        </b-form-group>
        <b-form-group
          label="Mail:"
        ...
        >
          <b-form-input
            ...
            disabled
            v-model="this.order.cliente.mail"
          ></b-form-input>
        </b-form-group>
        ...
        >
          <b-form-input
            ...
            disabled
            v-model="this.order.cliente.iva"
          ></b-form-input>
        </b-form-group>
      ...
      <b-card :title="avisosTitle" bg-variant="light">
        <b-container>
          <b-row>
            <b-col>
              <b-form-group label-for="aviso-fecha" label="Fecha">
                <b-form-input
                  id="aviso-fecha"
                  type="date"
              ...
              <b-form-group label-for="aviso-nombre" label="Nombre">
                <b-form-input id="aviso-nombre" v-model="currentAviso.nombre" />
              </b-form-group>
    ...
    <ModalSearchClient
      v-model="modalOpen"
      v-on:select-client="selectClient"
    ></ModalSearchClient>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    fields: function() {
      return this.edicionNacional
        ? ["fecha", "nombre"]
        : ["fecha", "pagina", "nombre"];
    },
    clienteSeleccionado: function () {
        return Object.keys(this.order.cliente).length !== 0;
    },
  },
  methods: {
    saveOrder() {
        ...
        console.log(this.order.cliente);
        if (!this.clienteSeleccionado) {
            this.showAlert("Cliente incompleto!");
            return;
        }
    ...
    editAviso(e) {
      ...
      this.order.avisos[
        this.currentAviso.index
      ].nombre = this.currentAviso.nombre;
      this.currentAviso.fecha = "";
      this.currentAviso.pagina = "";
      this.currentAviso.nombre = "";
      this.currentAviso.index = -1;
